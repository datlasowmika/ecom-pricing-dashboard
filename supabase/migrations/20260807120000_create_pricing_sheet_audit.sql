-- pricing_sheet_audit mirrors public.pricing_sheet, plus revision_id + revision_type.
-- revision_type: 0 = current, 1 = previous/historical.
-- Prefer the recreate migration if the table already existed with extra columns.
